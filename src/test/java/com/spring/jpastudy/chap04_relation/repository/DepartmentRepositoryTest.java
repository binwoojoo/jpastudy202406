...
class DepartmentRepositoryTest {
    ...
    @Test
    @DisplayName("양방향 연관 관계에서 연관데이터 수정")
    void changeTest() {
        //given
        ...
        /*
            사원 정보가 Employee엔터티에서 수정되어도
            반대편 엔터티인 Department에서는 르스트에 바로 반영되지 않는다.

            해결 방안은 데이터 수정시에 반대편 엔터티에도 같이 수정을 해줘라
         */

//        // 사원 정보 수정
//        employee.setDepartment(department);
//
//        // 핵심: 양방향에서는 반대편도 같이 수정
...
//        employee.setDepartment(null);
    ...
    @Test
    @DisplayName("양방향 관계에서 리스트에 데이터를 추가하면 데이터 DB에도 INSERT된다")
